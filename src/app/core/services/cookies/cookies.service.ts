...
export class CookiesService {
  ...
  /**
   * Saves all configured cookie consent options as the users cookie consent settings.
   */
  ...
  /**
   * Determines the current users cookie consent setting for the requested cookie consent option.
   * @param option The cookie consent option of interest.
   * @returns      'true' if the user has given the cookie consent for the requested option, 'false' otherwise.
   */
